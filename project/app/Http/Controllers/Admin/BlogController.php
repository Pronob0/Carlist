...
class BlogController extends Controller
{
    ...
    public function store(BlogRequest $request)
    {
        ...
        $input = $request->only('title', 'category_id', 'description', 'photo', 'status', 'tags');
    ...
    {
        $this->resource->update($request->only('title', 'category_id', 'description', 'photo', 'status', 'tags'), $blog);
