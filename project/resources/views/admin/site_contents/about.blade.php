...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('admin.frontend.content.update',$section->id)}}" method="POST"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <div class="gallery gallery-fw" data-item-height="300">
                                    <img class="gallery-item imageShow"
                                        data-image="{{getPhoto(@$section->content->image)}}">
                                </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="heading" class="form-control" placeholder="@lang('Heading')"
                                value="{{@$section->content->heading}}" required>
                        </div>
                        <div class="form-group col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('ID')">{{$info->number}}</td>
                            <td data-label="@lang('Action')">
                                <div
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-primary details btn-sm m-1"
                                        data-key="{{$key}}" data-item="{{json_encode($info)}}"
...
<script>
    'use strict';
        ...
        $('.details').on('click',function () { 
            ...
            $('#edit').find('input[name=number]').val(data.number)
